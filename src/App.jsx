          ...
          <div className="grid grid-cols-1 xl:grid-cols-3">
            ...
            <div className="p-2 px-5 w-96 mx-auto grid content-center">
              ...
              <div className={isNgrohjaOpen ? 'content' : 'hidden'}>
                ...
                <p className="dark:text-white text-text-blue">Programoni temperaturën e hapësirave tuaja sipas kohës së caktuar, duke pasur parasysh edhe tarifat ditë-natë (pas orës 22:00 energjia elektrike është më e lirë).</p>
              </div>
              <div className={isBojleriOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">01</h1>
                <p className="dark:text-white text-text-blue">Mundohuni ta mbani bojlerin të fikur gjatë ditës, ose së paku të zvogëloni kohën gjatë së cilës bojleri qëndron i ndezur.</p>
              </div>
              <div className={isGatimiOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">01</h1>
                <p className="dark:text-white text-text-blue">Përdorni gazin natyror si burim energjie për gatim kur të keni mundësi.</p>
              </div>
              <div className={isFrigoriferiOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">01</h1>
                <p className="dark:text-white text-text-blue">Zvogëloni nivelin e ftohjes në nivel optimal, për shembull nga niveli 4 në nivelin 1 ose në nivelin 2. Kjo do të kursejë 20-30 % të energjisë së shpenzuar më parë nga frigoriferi.</p>
              </div>
              <div className={isKondicioneriOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">01</h1>
                <p className="dark:text-white text-text-blue">Programoni termostatin e kondicionerit që të mos aktivizohet derisa temperatura e brendshme të kalojë 24°, e cila konsiderohet të jetë temperaturë efiçiente e dhomës gjatë verës.</p>
              </div>
              ...
              <div className={isGatimiOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">02</h1>
                <p className="dark:text-white text-text-blue">Përputhni madhësinë/sipërfaqen e tenxheres suaj të gatimit me madhësinë e pllakës së shporetit elektrik.</p>
              </div>
              <div className={isFrigoriferiOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">02</h1>
                <p className="dark:text-white text-text-blue">Hapni derën e frigoriferit vetëm kur është e nevojshme që të mos largohet i ftohti nga pajisja elektrike.</p>
              </div>
              <div className={isKondicioneriOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">02</h1>
              ...
              <div className={isBojleriOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">03</h1>
                <p className="dark:text-white text-text-blue">Ulni temperaturën e termostatit të bojlerit (temperatura e sugjeruar, 55-60 gradë).</p>
              </div>
              <div className={isGatimiOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">03</h1>
                <p className="dark:text-white text-text-blue">Fikni energjinë në furrë ose në pllakë të zierjes së paku 3-5 minuta më herët (para se ta largoni ushqimin nga pllaka ose furra).</p>
              </div>
              <div className={isKondicioneriOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">03</h1>
                <p className="dark:text-white text-text-blue">Vendoseni termostatin në atë që parashihet të jetë temperaturë e rehatshme e dhomës gjatë dimrit: nga 18-21 gradë.</p>
              ...
              <div className={isPajisjeOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">02</h1>
                <p className="dark:text-white text-text-blue">Përdorni programet më efiçiente që këto pajisje ofrojnë, kështu kurseni më shumë energji elektrike. Jo çdo herë duhet të zgjedhim programet më të gjata dhe me temperaturat më të larta. </p>
              </div>
              <div className={isPajisjeOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">03</h1>
                <p className="dark:text-white text-text-blue">Fikni dritat në hapësirat ku nuk kanë nevojë për ndriçim.</p>
              </div>
              <div className={isFrigoriferiOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">03</h1>
                <p className="dark:text-white text-text-blue">Prisni që ushqimet e nxehta të ftohen përpara se t'i vendosni brenda në frigorifer. Kjo do të shmangë që frigoriferi të punojë më shumë sesa që duhet normalisht për të mbajtur të freskët brendësinë e tij.</p>
              </div>
            </div>
            {/* Col 3 */}
            {/* 04 */}
            <div className="p-2 px-5 w-96 grid content-center mx-auto">
              <div className={isGatimiOpen ? 'content' : 'hidden'}>
                ...
                <p className="dark:text-white text-text-blue">Vendosni kapakun në tenxhere në mënyrë që përmbajtja të gatuhet ose të zihet më shpejt, sepse kështu shpenzohet më pak energji.</p>
              </div>
              <div className={isNgrohjaOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">04</h1>
                <p className="dark:text-white text-text-blue">Mbani dyert e dhomës së gjumit ose të zyrës të mbyllura sa më shumë që të jetë e mundur për të ruajtur nxehtësinë.</p>
              </div>
              <div className={isBojleriOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">04</h1>
                <p className="dark:text-white text-text-blue">Kufizoni shpenzimin e ujit të ngrohtë aty ky është e mundur, për shembull në lavamanin e kuzhinës ose të banjës.</p>
              </div>
              {/* <div className={isGatimiOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">04</h1>
              ...
              <div className={isPajisjeOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">04</h1>
                <p className="dark:text-white text-text-blue">Hiqni nga priza pajisjet elektronike gjatë kohës kur nuk janë në përdorim.</p>
              </div>
              <div className={isBojleriOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">05</h1>
              ...
              <div className={isGatimiOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">05</h1>
                <p className="dark:text-white text-text-blue">Përdorni enë të cilat i përshtaten volumit të ushqimit të përgatitur. Mos ngrohni ujë me tepër sesa ju nevojitet.</p>
              </div>
              <div className={isFrigoriferiOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">05</h1>
                <p className="dark:text-white text-text-blue">Mos lejoni të formohet trashësi e akullit në frigorifer dhe ngrirës, shkrini dhe pastroni atë, sepse do të jetë më efektive dhe më ekonomike.</p>
              </div>
              <div className={isKondicioneriOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">05</h1>
                <p className="dark:text-white text-text-blue">Kujdesuni  që kondicioneri juaj të aranzhohet në opsion optimal dhe jo më shumë se sa që është e nevojshme.</p>
              </div>
              <div className={isPajisjeOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">05</h1>
              ...
              <div className={isGatimiOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">06</h1>
                <p className="dark:text-white text-text-blue">Hapni derën e furrës vetëm kur është e nevojshme që të mos largohet nxehtësia nga pajisja elektrike.</p>
              </div>
              <div className={isKondicioneriOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">06</h1>
              ...
              <div className={isFrigoriferiOpen ? 'content' : 'hidden'}>
                <h1 className="p-1 text-[5rem] font-medium text-accent">06</h1>
                <p className="dark:text-white text-text-blue">Mbani frigoriferin larg pajisjeve që lirojnë nxehtësi, mbani atë në vendin më të ftohtë në shtëpi, kështu kujdeseni që temperaturat e ulëta të qëndrojnë vazhdimisht të tilla.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 mx-auto">
            ...
            <div className="px-5 grid">
              <div className="w-auto md:w-96 mx-auto">
                <h1 className="p-1 text-[5rem] font-medium text-accent">03</h1>
                <p className="dark:text-white text-text-blue">Përdorimi i gazit për gatim ul dukshëm konsumin e energjisë elektrike. Nëse nuk përdorni gaz për gatim, atëherë përpiquni ta hapni sa më pak furrën gjatë pjekjes.</p>
              </div>
              <div className="w-auto md:w-96 mx-auto">
                <h1 className="p-1 text-[5rem] font-medium text-accent">04</h1>
              ...
              <div className="w-auto md:w-96 mx-auto">
                <h1 className="p-1 text-[5rem] font-medium text-accent">06</h1>
                <p className="dark:text-white text-text-blue">Nëse keni mundësi, instaloni sensorë të lëvizjes për të ndezur dhe fikur dritat në hapësirat që nuk janë në përdorim të vazhdueshëm (p.sh korridore, tualete).</p>
              </div>
        ...
        <div ref={mallRef} className="py-16 mall">
          <div className="grid grid-cols-1 xl:grid-cols-3">
            ...
            <div className="px-5 xl:pr-48 grid content-center">
              <div className="w-auto md:w-96 xl:w-auto mx-auto">
                <h1 className="p-1 text-[5rem] font-medium text-accent">04</h1>
                <p className="dark:text-white text-text-blue">Programoni ftohjen të mos fillojë derisa temperatura e brendshme të kalojë 24°, apo ngrohja të akordohet nga 18-21 °C gjatë dimrit.</p>
              </div>
              <div className="w-auto md:w-96 xl:w-auto mx-auto">
                <h1 className="p-1 text-[5rem] font-medium text-accent">05</h1>
        ...
        <div ref={gastronomyRef} className="py-16 gastronomy">
          ...
          <div className="">
            ...
            <div className="px-5 grid content-center">
              ...
              <div className="w-auto md:w-96 xl:w-auto mx-auto">
                <h1 className="p-1 text-[5rem] font-medium text-accent">02</h1>
                <p className="dark:text-white text-text-blue">Gjatë natës, mos harroni ta fikni ndriçimin dhe të gjitha pajisjet e tjera shpenzuese.</p>
              </div> 
              <div className="w-auto md:w-96 xl:w-auto mx-auto">
                <h1 className="p-1 text-[5rem] font-medium text-accent">03</h1>
              ...
              <div className="w-auto md:w-96 xl:w-auto mx-auto">
                <h1 className="p-1 text-[5rem] font-medium text-accent">04</h1>
                <p className="dark:text-white text-text-blue">Nëse nuk keni alternativë të ngrohjes (përpos me energji elektrike) për ditët e ftohta, akordoni termostatin në atë mënyrë që ambienti të jetë i rehatshëm, por jo i ftohtë. Temperatura e rehatshme e dhomës gjatë dimrit parashihet të jetë 19 gradë.</p>
              </div>
            ...
            <div className="px-5 grid content-start xl:grid-rows-3">
              ...
              <div className="xl:pr-48 w-auto md:w-96 xl:w-auto mx-auto">
                <h1 className="p-1 text-[5rem] font-medium text-accent">05</h1>
                <p className="dark:text-white text-text-blue">Gjatë ditës, ndalni ngrohjen tërësisht për disa orë. Kjo nuk do të ndikojë aq shumë në ndryshimin e temperaturës së rehatshme të hapësirave, por kursimi në anën tjetër do të jetë i madh.</p>
              </div>
              <div className="xl:pr-48 w-auto md:w-96 xl:w-auto mx-auto">
                <h1 className="p-1 text-[5rem] font-medium text-accent">06</h1>
        ...
        <div ref={institutionRef} className="py-16 institution">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3">
            ...
            <div className="px-5 w-auto xl:w-96 grid mx-auto">
              ...
              <div className="w-auto md:w-96 xl:w-auto mx-auto">
                <h1 className="p-1 text-[5rem] font-medium text-accent">01</h1>
                <p className="dark:text-white text-text-blue">Meqenëse po i afrohemi stinëve të ftohta, duhet pasur parasysh që ngrohja me energji elektrike përbën rreth 70% të faturës mujore. Nga kjo kuptohet se shpenzuesi më i madh i energjisë është ngrohja. Andaj, nëse është e mundur siguroni mundësi alternative të ngrohjes, sepse mos ngrohja me energji elektrike do ta ndihmonte shumë sistemin. </p>
              </div>
              <div className="w-auto md:w-96 xl:w-auto mx-auto">
                <h1 className="p-1 text-[5rem] font-medium text-accent">02</h1>
            ...
            <div className="px-5 w-auto xl:w-96 content-start">
              ...
              <div className="w-auto md:w-96 xl:w-auto mx-auto">
                <h1 className="p-1 text-[5rem] font-medium text-accent">04</h1>
                <p className="dark:text-white text-text-blue">Në fund të orarit të punës,  ku është e mundur, të ndërpritet energjia elektrike në mënyrë automatike apo të bëhet shkyçje përmes pajisjeve të mençura. Në kohë krize, çdo kilovat i kursyer është i vlefshëm, andaj,  të fillojmë nga sot t’i ndalim pajisjet që nuk i përdorim dhe të kursejmë në mënyrë maksimale.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3">
            ...
            {/* Col 2 */}
              <div className="w-96 grid mx-auto">
                ...
                <div className="w-auto md:w-96 xl:w-auto mx-auto">
                  <h1 className="p-1 text-[5rem] font-medium text-accent">03</h1>
                  <p className="dark:text-white text-text-blue">Minimizoni ose fikni dritat dekorative dhe reklamuese, pasi që ndriçimi i shumtë i reklamave në dyqane është shpenzues mjaft i madh i energjisë elektrike.</p>
                </div>
                <div className="w-auto md:w-96 xl:w-auto mx-auto">
                  <h1 className="p-1 text-[5rem] font-medium text-accent">04</h1>
            ...
            <div className="px-5 xl:pr-48 grid content-start">
              <div className="w-auto md:w-96 xl:w-auto mx-auto">
                <h1 className="p-1 text-[5rem] font-medium text-accent">05</h1>
                <p className="dark:text-white text-text-blue">Fikni dritat në ato hapësira që nuk përdoren. Përdorni llamba efiçiente, pra llamba LED.</p>
              </div>
              <div className="w-auto md:w-96 xl:w-auto mx-auto">
                <h1 className="p-1 text-[5rem] font-medium text-accent">06</h1>
                <p className="dark:text-white text-text-blue">Largoni spinën e pajisjeve elektronike nga priza. Disa pajisje ende konsumojnë një sasi të vogël të energjisë elektrike kur futen në prizë.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div ref={industryRef} className="py-16 industry">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3">
            ...
            <div className="grid px-5 w-auto xl:w-96 mx-auto">
                <div className="w-auto md:w-96 xl:w-auto mx-auto">
                  <h1 className="p-1 text-[5rem] font-medium text-accent">02</h1>
                  <p className="dark:text-white text-text-blue">Një mënyrë tjetër e thjeshtë është të siguroheni që të gjitha makineritë dhe pajisjet të fiken kur nuk përdoren. Përdorimi i pajisjeve vetëm kur ju nevojiten mund të rezultojë në kursime të konsiderueshme në kostot e energjisë elektrike.</p>
                </div> 
                <div className="w-auto md:w-96 xl:w-auto mx-auto">
                  <h1 className="p-1 text-[5rem] font-medium text-accent">03</h1>
                ...
                <div className="w-auto md:w-96 xl:w-auto mx-auto">
                  <h1 className="p-1 text-[5rem] font-medium text-accent">04</h1>
                  <p className="dark:text-white text-text-blue">Një dhomë e mbyllur siç duhet ndihmon kondicionerin të përdorë më pak energji.</p>
                </div>
                {/* <div className="">
                  <h1 className="p-1 text-[5rem] font-medium text-accent">05</h1>
